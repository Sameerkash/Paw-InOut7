...
var ForumPostArr = [
  ...
  new ForumPostEntry("User3", "2 Days ago", 5 , 0 , "My Cad is just under 5.6Kg, he gets chews a couple of times a week? I only feed gross animal bits chews (and occasionally Yakkers) rather than more highly processed carbohydrate commercial chews, but I separate them out in my head into high fat and low fat categories, and won't give a high fat one twice in one week.Cad gets most of his food as part of training, and the situation where he gets chews are thing where I'm busy and need him to occupy himself quietly, which also results in less training time. So effectively he gets that instead of say 1/3 of his daily food allowance? But I just roughly balance it up in my head. It does help though that I have scales I can weigh him on at home, so I can tell very quickly if I've messed up somewhere."),
